...
pickle.dump(vectorizerMap,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/vectorizer-1000.pkl','wb'))
pickle.dump(X,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/X-1000.pkl','wb'))
pickle.dump(Y,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y-1000.pkl','wb'))

pickle.dump(remainining_indices,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/test_indices_1000.pkl','wb'))
...
X = pickle.load(open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/X-1000.pkl','rb'))
Y = pickle.load(open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y-1000.pkl','rb'))
...
pickle.dump(y_arr,open("/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y_classified-1000.pkl",'wb'))
pickle.dump(dataBucketMap,open("/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/regression_bucket.pkl-1000",'wb'))