...
vectorizerMap = pickle.load(open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/vectorizer-{}.pkl'.format(vecture_features),'rb'))
vecture_features = 2000


# Path for training data csv file
filePath = '/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/dataset/Test_rev1.csv'
...
pickle.dump(X,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/X-true-test.pkl','wb'))