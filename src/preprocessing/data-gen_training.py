...
filePath = '/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/dataset/Train_rev1.csv'
...
pickle.dump(vectorizerMap,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/vectorizer-{}.pkl'.format(vecture_features),'wb'))
pickle.dump(X,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/X-{}.pkl'.format(vecture_features),'wb'))
pickle.dump(Y,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y-{}.pkl'.format(vecture_features),'wb'))
pickle.dump(X_test,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/X-test-{}.pkl'.format(vecture_features),'wb'))
pickle.dump(Y_test,open('/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y-test-{}.pkl'.format(vecture_features),'wb'))
...
pickle.dump(test_arr,open("/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y_classified-test-{}.pkl".format(vecture_features),'wb'))
pickle.dump(train_arr,open("/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/Y_classified-{}.pkl".format(vecture_features),'wb'))
pickle.dump(dataBucketMap,open("/home/ashish/Development/6th Sem/Minor Project/Job Salary Prediction/pkl-files/python-3.0/regression_bucket-{}.pkl".format(vecture_features),'wb'))